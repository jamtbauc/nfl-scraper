...
(
    ...
    pass_first_down_pct numeric(4,1) NOT NULL DEFAULT 0.0,
    ...
    rush_broken_tacks smallint NOT NULL DEFAULT 0,
    rushes_per_broken_tack numeric(3,1) NOT NULL DEFAULT 0.0,
    ...
    rec_broken_tacks smallint NOT NULL DEFAULT 0,
    recs_per_broken_tack numeric(3,1) NOT NULL DEFAULT 0,
    ...
    avg_def_tgt_yds_att numeric(3,1) NOT NULL DEFAULT 0.0,
    def_air_yds smallint NOT NULL DEFAULT 0,
    def_yac smallint NOT NULL DEFAULT 0,
    blitzes smallint NOT NULL DEFAULT 0,
    hurries smallint NOT NULL DEFAULT 0,
    qb_knockdowns smallint NOT NULL DEFAULT 0,
    pressures smallint NOT NULL DEFAULT 0,
    def_missed_tacks smallint NOT NULL DEFAULT 0,
