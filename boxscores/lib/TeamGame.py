...
class TeamGame:
    ...
    def getInfo(self):
        info = {
            ...
            "won_toss": self.getWonToss(),
            "toss_decision": self.getTossDecision(),
            "is_home": self.getIsHome(),
            "is_favored": self.getIsFavored(),
            "spread": self.getSpread(),
            "over_under": self.getOverUnder(),
            "first_downs": self.getFirstDowns(),
            ...
            "net_pass_yds": self.getNetPassYds(),
            "total_yds": self.getTotalYds(),
            "fumbles": self.getFumbles(),
            "fumbles_lost": self.getFumblesLost(),
            "turnovers": self.getTurnovers(),
            "penalties": self.getPenalties(),
            "penalty_yds": self.getPenaltyYds(),
            "third_down_atts": self.getThirdDownAtts(),
