...
class PlayerGame:
    ...
    def getInfo(self):
        info = {
            ...
            "def_tack_comb": self.getDefTacksComb(),
            "def_tack_solo": self.getDefTacksSolo(),
            "def_tack_assist": self.getDefTacksAssist(),
            "def_tack_loss": self.getDefTacksLoss(),
            ...
            "pass_intended_air_yds": self.getPassTgtYds(),
            "avg_pass_intended_air_yds": self.getPassTgtYdsPerAtt(),
            "pass_air_yds": self.getPassAirYds(),
            "avg_pass_air_yds_comp": self.getPassAirYdsPerComp(),
            "avg_pass_air_yds_att": self.getPassAirYdsPerAtt(),
            "pass_yac": self.getPassYac(),
            "avg_pass_yac_comp": self.getPassYacPerComp(),
            "pass_drops": self.getPassDrops(),
            "pass_drop_pct": self.getPassDropPct(),
            "poor_throws": self.getPassPoorThrows(),
            "poor_throw_pct": self.getPassPoorThrowPct(),
            "passes_blitzed": self.getPassBlitzed(),
            "passes_hurried": self.getPassHurried(),
            "passes_hit": self.getPassHits(),
            "passes_pressured": self.getPassPressured(),
            "pass_pressured_pct": self.getPassPressuredPct(),
            "scrambles": self.getRushScrambles(),
            "avg_scramble_yds": self.getRushScramblesYdsPerAtt(),
            "rush_first_down": self.getRushFirstDown(),
            "rush_ybc": self.getRushYdsBeforeContact(),
            "avg_rush_ybc": self.getRushYdsBcPerRush(),
            "rush_yac": self.getRushYac(),
            "avg_rush_yac": self.getRushYacPerRush(),
            "rush_broken_tacks": self.getRushBrokenTacks(),
            "rushes_per_broken_tack": self.getRushPerBrokenTackle(),
            "rec_first_down": self.getRecFirstDown(),
            "rec_air_yds": self.getRecAirYds(),
            "avg_rec_air_yds": self.getRecAirYdsPerRec(),
            "rec_yac": self.getRecYac(),
            "avg_rec_yac": self.getRecYacPerRec(),
            "rec_adot": self.getRecAdot(),
            "rec_broken_tacks": self.getRecBrokenTacks(),
            "recs_per_broken_tack": self.getRecPerBrokenTackle(),
            ...
            "avg_def_yds_comp": self.getDefYdsPerComp(),
            "avg_def_yds_tgt": self.getDefYdsPerTarget(),
            "def_comp_tds": self.getDefCompTds(),
            "def_pass_rating": self.getDefPassRating(),
            "avg_def_tgt_yds_att": self.getDefTgtYdsPerAtt(),
            "def_air_yds": self.getDefAirYds(),
            "def_yac": self.getDefYac(),
            "blitzes": self.getBlitzes(),
            "hurries": self.getQbHurries(),
            "qb_knockdowns": self.getQbKnockdown(),
            "pressures": self.getPressures(),
            "def_missed_tacks": self.getTacksMissed(),
            "def_missed_tack_pct": self.getTacksMissedPct(),
