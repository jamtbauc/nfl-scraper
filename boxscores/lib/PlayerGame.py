...
class PlayerGame:
    def __init__(self, id, playerId):
        ...
        self.rush_per_broken_tackle = 0.0
        ...
        self.rec_per_broken_tackle = 0.0 
        self.rec_drops = 0 
    ...
    def getRushPerBrokenTackle(self):
        return self.rush_per_broken_tackle
    ...
    def getRecPerBrokenTackle(self): 
        return self.rec_per_broken_tackle
    ...
    def getInfo(self):
        info = {
            ...
            "tmGame_id": self.getGameId(),
            "pass_comps": self.getPassComps(),
            "pass_atts": self.getPassAtts(),
            "pass_yds": self.getPassYds(),
            "pass_tds": self.getPassTds(),
            "pass_ints": self.getPassInts(),
            "sacked": self.getSacked(),
            "sack_yds_lost": self.getSackYdsLost(),
            "long_pass": self.getLongPass(),
            "pass_rating": self.getPassRating(),
            "rush_atts": self.getRushAtts(),
            "rush_yds": self.getRushYds(),
            "rush_tds": self.getRushTds(),
            "long_rush": self.getLongRush(),
            "rec_targets": self.getRecTargets(),
            "recs": self.getReceptions(),
            "rec_yds": self.getRecYds(),
            "rec_tds": self.getRecTds(),
            "long_rec": self.getLongRec(),
            "fumbles": self.getFumbles(),
            "fumbles_lost": self.getFumblesLost(),
            "def_ints": self.getDefInt(),
            "def_int_yds": self.getDefIntYds(),
            "def_int_tds": self.getDefIntTds(),
            "long_def_int": self.getLongDefInt(),
            "pass_defs": self.getPassDefs(),
            "def_sacks": self.getDefSacks(),
            "def_tack_combined": self.getDefTacksComb(),
            "def_tack_solo": self.getDefTacksSolo(),
            "def_tack_assists": self.getDefTacksAssist(),
            "def_tack_for_loss": self.getDefTacksLoss(),
            "def_qb_hits": self.getDefQbHits(),
            "fumble_recs": self.getFumbleRecs(),
            "fumble_rec_yds": self.getFumbleRecYds(),
            "fumble_rec_tds": self.getFumbleRecTds(),
            "forced_fumbles": self.getForcedFumbles(),
            "kick_rets": self.getKickRets(),
            "kick_ret_yds": self.getKickRetYds(),
            "avg_kick_ret": self.getAvgKickRet(),
            "kick_ret_tds": self.getKickRetTds(),
            "long_kick_ret": self.getLongKickRet(),
            "punt_rets": self.getPuntRets(),
            "punt_ret_yds": self.getPuntRetYds(),
            "avg_punt_ret": self.getAvgPuntRet(),
            "punt_ret_tds": self.getPuntRetTds(),
            "long_punt_ret": self.getLongPuntRet(),
            "xpm": self.getXpm(),
            "xpa": self.getXpa(),
            "fgm": self.getFgm(),
            "fga": self.getFga(),
            "punts": self.getPunts(),
            "punt_yds": self.getPuntYds(),
            "avg_punt": self.getAvgPunt(),
            "long_punt": self.getLongPunt(),
            "pass_first_downs": self.getPassFirstDowns(),
            "pass_first_down_pct": self.getPassFirstDownPct(),
            "pass_tgt_yds": self.getPassTgtYds(),
            "pass_tgt_yds_per_att": self.getPassTgtYdsPerAtt(),
            "pass_air_yds": self.getPassAirYds(),
            "pass_air_yds_per_comp": self.getPassAirYdsPerComp(),
            "pass_air_yds_per_att": self.getPassAirYdsPerAtt(),
            "pass_yac": self.getPassYac(),
            "pass_yac_per_comp": self.getPassYacPerComp(),
            "pass_drops": self.getPassDrops(),
            "pass_drop_pct": self.getPassDropPct(),
            "pass_poor_throws": self.getPassPoorThrows(),
            "pass_poor_throw_pct": self.getPassPoorThrowPct(),
            "pass_blitzed": self.getPassBlitzed(),
            "pass_hurried": self.getPassHurried(),
            "pass_hits": self.getPassHits(),
            "pass_pressured": self.getPassPressured(),
            "pass_pressured_pct": self.getPassPressuredPct(),
            "rush_scrambles": self.getRushScrambles(),
            "rush_scrambles_yds_per_att": self.getRushScramblesYdsPerAtt(),
            "rush_first_down": self.getRushFirstDown(),
            "rush_yds_before_contact": self.getRushYdsBeforeContact(),
            "rush_yds_bc_per_rush": self.getRushYdsBcPerRush(),
            "rush_yac": self.getRushYac(),
            "rush_yac_per_rush": self.getRushYacPerRush(),
            "rush_broken_tacks": self.getRushBrokenTacks(),
            "rush_per_broken_tack": self.getRushPerBrokenTackle(),
            "rec_first_down": self.getRecFirstDown(),
            "rec_air_yds": self.getRecAirYds(),
            "rec_air_yds_per_rec": self.getRecAirYdsPerRec(),
            "rec_yac": self.getRecYac(),
            "rec_yac_per_rec": self.getRecYacPerRec(),
            "rec_adot": self.getRecAdot(),
            "rec_broken_tacks": self.getRecBrokenTacks(),
            "rec_per_broken_tack": self.getRecPerBrokenTackle(),
            "rec_drops": self.getRecDrops(),
            "rec_drop_pct": self.getRecDropPct(),
            "rec_target_int": self.getRecTargetInt(),
            "rec_pass_rating": self.getRecPassRating(),
            "def_targets": self.getDefTargets(),
            "def_comps": self.getDefComps(),
            "def_comp_pct": self.getDefCompPct(),
            "def_comp_yds": self.getDefCompYds(),
            "def_yds_per_comp": self.getDefYdsPerComp(),
            "def_yds_per_target": self.getDefYdsPerTarget(),
            "def_comp_tds": self.getDefCompTds(),
            "def_pass_rating": self.getDefPassRating(),
            "def_tgt_yds_per_att": self.getDefTgtYdsPerAtt(),
            "def_air_yds": self.getDefAirYds(),
            "def_yac": self.getDefYac(),
            "blitzes": self.getBlitzes(),
            "qb_hurries": self.getQbHurries(),
            "qb_knockdown": self.getQbKnockdown(),
            "pressures": self.getPressures(),
            "tacks_missed": self.getTacksMissed(),
            "tacks_missed_pct": self.getTacksMissedPct(),
            "is_starter": self.getIsStarter(),
            "starting_pos": self.getStartingPos()
        }
